...
HTMLActuator.prototype.debug = function(message) {
  if (this.messageDebug.textContent != "")
    this.messageDebug.textContent += "\r\n";    
  this.messageDebug.textContent += message;
};

HTMLActuator.prototype.debugClear = function(message) {
  this.messageDebug.textContent = "";
};
